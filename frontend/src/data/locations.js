export const stateDistrictData = {
    ...
    "Andhra Pradesh": [
        ...
        "Kurnool", "Manyam", "Nandyal", "Nellore", "NTR", "Palnadu", "Prakasam",
        "Sri Balaji", "Sri Satya Sai", "Srikakulam", "Tirupati",
        "Visakhapatnam", "Vizianagaram", "West Godavari", "YSR"
    ],
    "Arunachal Pradesh": [
        "Tawang", "West Kameng", "East Kameng", "Pakke-Kessang", "Papum Pare",
        "Kra Daadi", "Kurung Kumey", "Lower Subansiri", "Kamle", "Upper Subansiri",
        "West Siang", "Liromoba", "Leparada", "Shi-Yomi", "East Siang",
        "Upper Siang", "Lower Siang", "Upper Dibang Valley", "Lower Dibang Valley",
        "Lohit", "Namsai", "Anjaw", "Changlang", "Tirap", "Longding"
    ],
    "Assam": [
    ...
    "Madhya Pradesh": [
        ...
        "Mandla", "Mandsaur", "Morena", "Narmadapuram", "Narsinghpur",
    ...
    "Nagaland": [
        ...
        "Mon", "Niuland", "Noklak", "Peren", "Phek", "Tuensang", "Tseminyu", "Wokha", "Zunheboto"
    ],
    "Odisha": [
    ...
    "Rajasthan": [
        "Ajmer", "Alwar", "Anupgarh", "Balotra", "Baran", "Barmer", "Beawar",
    ...
    "Tamil Nadu": [
        ...
        "Thanjavur", "Theni", "Thoothukudi", "Thiruchirappalli",
        "Thirunelveli", "Thirupathur", "Thirupattur", "Thiruvallur",
        "Thiruvannamalai", "Thiruvarur", "Tirupur", "Vellore", "Viluppuram",
        "Virudhunagar"
    ],
    "Telangana": [
